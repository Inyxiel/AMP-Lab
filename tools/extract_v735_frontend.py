#!/usr/bin/env python3
"""Extract the exact embedded frontend resources from AMP Lab v7.3.5.

This tool intentionally accepts only the verified v7.3.5 Tooltip Restore Fix
binary so older builds cannot be mixed into the repository by accident.
"""
...
EXPECTED_SHA256 = "2b7f75480c27072c9447624aa6356c9cc217f922cc818b95a20766e188c2ae5c"
...
def main() -> int:
    ...
    parser.add_argument("exe", type=Path, help="AMP Lab v7.3.5 Tooltip Restore Fix executable")
    parser.add_argument("--out", type=Path, default=Path("recovered/v7.3.5"))
    ...
    if size != EXPECTED_SIZE or digest.lower() != EXPECTED_SHA256:
        raise SystemExit(
            "Refusing to extract: this is not the verified AMP Lab v7.3.5 baseline.\n"
    ...
    # v7.3.5 embeds the main JS payload as base64(gzip(JavaScript)).
